...
namespace CompactMapper
{
    /// <summary>
    /// CompactMapper is a lightweight, fast, and fully open-source object mapper for .NET 
    /// that lets you map objects between types — including complex types and collections — with just one line of code.
    /// </summary>
    public static class CompactMapperExtension
    {
        ...
        /// <summary>
        /// Adds a custom mapping action for a specific source and destination type pair.
        /// </summary>
        /// <typeparam name="TSource">The source type</typeparam>
        /// <typeparam name="TDestination">The destination type</typeparam>
        /// <param name="mappingAction">The custom mapping action to apply during mapping</param>
        ...
        /// Maps properties by name (case-insensitive) and supports nested objects and collections.
        /// </summary>
        /// <typeparam name="TDestination">The destination type to map to</typeparam>
        /// <param name="source">The source object to map from</param>
        /// <param name="recursive">Whether to recursively map nested complex objects (default: true)</param>
        /// <param name="valueTransformer">Optional function to transform property values during mapping</param>
